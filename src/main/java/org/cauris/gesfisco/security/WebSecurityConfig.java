package org.cauris.gesfisco.security;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .authorizeRequests()
                ...
                .antMatchers("/gesfisco/login").permitAll()
                .antMatchers("/gesfisco/users/errors/*").permitAll()
                .antMatchers("/gesfisco/admin/errors/*").permitAll()
                .antMatchers("/gesfisco/errors/*").permitAll()
                .antMatchers("/hello").hasAnyRole("ADMIN","ECONOME")
                .antMatchers("/home").hasAnyRole("ADMIN","ECONOME")
                .antMatchers("/gesfisco/users/*").hasAnyRole("ECONOME")
                .antMatchers("/gesfisco/admin/*").hasAnyRole("ADMIN")
            ...
            .logout()
                .permitAll()
                .logoutSuccessUrl("/gesfisco/index?logout")
            .and()
            .exceptionHandling().accessDeniedHandler(accessDeniedHandler)
            .and()
            .csrf().disable()
            .sessionManagement()
            .invalidSessionUrl("/gesfisco/index?logout");// /logout accessDeniedHandler(accessDeniedHandler) exceptionHandling().accessDeniedPage("/gesfisco/errors/403")
